...
<label className='block'>Role</label>
            <select className="mt-4 mb-12 w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-700">
  ...
  <option value="manager">Manager</option>
          ...
          <div className="text-center mt-6">
            <a href="#" >Arleady have an Account?<Link to='/LoginPage' className="text-blue-600 text-sm hover:underline">Click here</Link></a>
          </div>
        </div>
      </div>
